...
#'
#' transformation = "binary" can be used to tranform tax abundances into presence/abundance data.
...
#' @export
#' @seealso \code{microbiome \link[microbiome]{transform}} for info on other transformations available

...
**:snake: conda** **users** - if you encounter compilation errors when installing dependencies like `ggiraph` or `httpuv` (e.g. `cannot find -lz`), you may need to install system libraries in your conda environment first:

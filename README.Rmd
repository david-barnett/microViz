...
-   **The ["Get started"](https://david-barnett.github.io/microViz/articles/web-only/microViz.html) page** shows a few example analyses (as does this ReadMe)
...
-   **The Articles pages** give tutorials and further examples
    ...
    -   [Visualising taxonomic compositions with comp_barplot](https://david-barnett.github.io/microViz/articles/articles/compositions.html)

...
```{r plot clr pca with tax loading, fig.height=6, fig.width=8}
pca
```

What about the actual compositions of these 800 samples?

```{r iris plot, fig.width=8, dpi=120}
iris <- clr_pca %>%
  ord_plot_iris(
...
```{r paired plots, fig.height=10, fig.width=8, dpi=120}
pca / iris 
```
...
tt_stats %>% 
  taxatree_plotkey(
    ...
    rank == "Phylum", label_fun_args = list(size = 4),

...
🔬 `microViz` extends or complements popular microbial ecology packages,
including `phyloseq`, `vegan`, & `microbiome`.

## Learn more

📎 This website is the best place for documentation and examples:
...
**🍎 macOS** **users** - might need to install
...
for managing your R package installations across multiple projects.

🐳 For Docker users an image with the main branch installed is available
at: <https://hub.docker.com/r/barnettdavid/microviz-rocker-verse>

📅 microViz is tested to work with recent R versions on Windows, MacOS,
and Ubuntu. R versions below 4 are no longer supported since 0.13.0 (R
4.0.0 was released in 2020).
...
![](articles/web-only/images/20210429_ord_explore_x175.gif)
...
![](reference/figures/README-compheatmap-1.png)
...
![](reference/figures/README-ordination-plot-1.png)
...
![](reference/figures/README-constrained-ord-plot-1.png)
